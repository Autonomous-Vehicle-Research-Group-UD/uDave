...
# 
#CAMERA
CAMERA_TYPE = "D435"   # (PICAM|WEBCAM|CVCAM|CSIC|V4L|D435|MOCK|IMAGE_LIST|T265)
CAMERA1_ID = 1
IMAGE_W = 424 # Minimum width: 424 in case of D435
IMAGE_H = 240 # Minimum height: 240 in case of D435
IMAGE_DEPTH = 3         # default RGB=3, make 1 for mono

DRIVING_MIRROR_W_1 = 160
DRIVING_MIRROR_H_1 = 120

DRIVING_MIRROR_W_2 = 160
DRIVING_MIRROR_H_2 = 120
...
HAVE_MARVELMIND = False     #Turn on/off the GPS
MARVELMIND_SERVICES = ["gps", "imu"] #List of services. Available: "gps", "quality", "imu", "imu-fusion"
MARVELMIND_TTY = "/dev/ttyACM0" #Pseudofile of the beacons USB connection
HEDGE_ADDR = 5

NEED_SPEED = True
SPEED_PIN_1 = 12 # Number of pin on board
SPEED_PIN_2 = 16
SPEED_PIN_3 = 18
SPEED_PIN_4 = 22 
...
#SECONDARY CSIC CAMERA USE THE SAME PARAMETERS AS THE PRIMARY, EXCEPT ID
SECONDARY_CAMERA_ENABLED = False
CAMERA2_ID = 1

LIDAR_1 = True
LIDAR_1_PORT = '/dev/LIDAR_1'
LIDAR_1_MODE = 'EXPRESS'
LIDAR_1_PWM = 500

LIDAR_2 = True
LIDAR_2_PORT = '/dev/LIDAR_2'
LIDAR_2_MODE = 'EXPRESS'
LIDAR_2_PWM = 500


# FRONT LIDAR 2
FRONTLIDAR2_ENABLED = False
FRONTLIDAR2_PORT = "/dev/ttyUSB0"

# SIDE LIDAR 1
SIDELIDAR1_ENABLED = False
SIDELIDAR1_PORT = "/dev/ttyUSB1"

# SIDE LIDAR 2
SIDELIDAR2_ENABLED = False
SIDELIDAR2_PORT = "/dev/ttyUSB2"

# REAR LIDAR
REARLIDAR_ENABLED = False
REARLIDAR_PORT = "/dev/ttyUSB3"
